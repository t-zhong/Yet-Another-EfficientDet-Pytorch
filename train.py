...
def get_args():
    ...
    # parser.add_argument('--device', type=int, default=1, help='gpu to be used when only one gpu is spedified')
...
def train(opt):
    ...
    # move the model to gpu(s) before wraping it in optimizer.
    if params.num_gpus > 0:
        model = model.cuda()
